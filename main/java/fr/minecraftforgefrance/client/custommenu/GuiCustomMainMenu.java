...
public class GuiCustomMainMenu extends GuiScreen
{
	...
	private void addSingleplayerMultiplayerButtons(int x, int y)
	{
		...
		this.buttonList.add(new GuiButton(20, this.width / 2 - 100, x + y * 1, "Aller sur le serveur !"));
		GuiButton webSiteButton = new GuiButton(21, this.width / 2 - 100, x + y * 2, 98, 20, "Notre site");
		fmlModButton = new GuiButton(6, this.width / 2 + 2, x + y * 2, 98, 20, "Mods");
	...
	protected void actionPerformed(GuiButton button)
	{
		...
		if(button.id == 14 && this.minecraftRealmsButton.visible)
		{
			this.func_140005_i();
		}
		...
		if(button.id == 20)
		{
			...
			FMLClientHandler.instance().connectToServerAtStartup("minecraft62.omgserv.com", 12686); // ip,
																							// port
		}
		...
		if(button.id == 21)
		{
			try
			{
				...
				oclass.getMethod("browse", new Class[] {URI.class}).invoke(object, new Object[] {new URI("http://heritiers.wix.com/minecraft#!home/mainPage")});
			}
